...
//ASDQ, //낫 휘두르기 - 전방(에어리얼)
//WADQ, //낫 휘두르기 - 하단(띄움)
//WASDWWQ, //궁극기1 땅으로 판정되는 곳이 전부 나이프로 바뀌어 하늘로 사출 후 하늘에서 나이프가 쏟아내림.
//SSDQ, //스텍 1 소모, 돌진베기(관통)
//SSADQ, //스텍 2 소모, 나이프 뿌리기 (표식)
//ADADQ, //반격기, 발동 시 연출과 함께 끝까지 추적해 공격 후 표식 부여
//QWEASDQ, //궁극기2 광범위한 지역에 마법진 비스무리한거 생성. 15초 뒤 일대를 초토화 시키는 공격 사용. 모든 이에게 강력한 데미지, 자기 자신도 데미지 받음.
//SDQ, //스텍 1 소모, 나이프 던지기 (표식), 이미 표식이 붙은 적이 있을 때 SDQ 를 쓴다면 대상을 추적하여 나이프로 베어냄.
//ASE, //2회 사용 가능, 발걸고 강펀치
//ADDQ, //사선베며 내려오기(관통)
//ASDASDQ, //낫 휘두르기 - 강하게
//DASQ, //돌려내려찍기 (뒤에 Q 홀드 시 차징 가능)
//SAX, //발로 여러 번 차 나아감.
